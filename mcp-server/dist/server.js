...
server.setRequestHandler(ListToolsRequestSchema, async () => {
    return {
        tools: [
            {
                name: 'lint',
                description: 'Run linters on a project and return structured issues. Returns errors categorized by fixability: auto-fixable (by linter tools), Claude-fixable (complexity, types), and manual-only.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        path: {
            ...
            {
                name: 'fix',
                description: 'Run linter auto-fix on a project. This runs eslint --fix, prettier --write, etc. Only fixes issues that tools can auto-fix; Claude-fixable issues require separate handling.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        path: {
