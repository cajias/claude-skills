...
def index_cmd() -> None:
    ...
    vault_path = os.environ.get("SEMANTIC_SEARCH_VAULT_PATH", "/Users/rc/Documents/Obsidian Vault")
    db_path = os.environ.get("SEMANTIC_SEARCH_DB_PATH", "/Users/rc/Documents/Obsidian Vault/.lancedb")
