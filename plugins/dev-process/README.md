...
| `milestone-goal-prompt`  | Print a copy-paste autonomous-loop prompt that drives a GitHub/GitLab milestone to completion. Ships a Workflow engine for large milestones. |
