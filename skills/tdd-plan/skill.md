...
I generate comprehensive TDD-based plans formatted for execution via `ralph-loop`. The plan includes master goals, concurrent task phases, and strict exit criteria including code review validation.
