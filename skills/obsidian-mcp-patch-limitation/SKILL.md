...
The Obsidian MCP server's `obsidian_patch_content` function cannot target sub-headings (H2, H3, etc.) when a higher-level heading exists in the file. This makes surgical editing of specific sections impossible via the standard approach.
